...
public class GatheringChannellingUI : MonoBehaviour
{
    private static GatheringChannellingUI _instance;
    public static GatheringChannellingUI Instance => _instance;

    [Header("UI Settings")]
    [SerializeField] private Vector2 panelSize = new Vector2(350, 120);
    [SerializeField] private float panelYOffset = 50f;

    [Header("Colors - Nature Theme")]
    [SerializeField] private Color panelColor = new Color(0.1f, 0.15f, 0.05f, 0.95f); // Koyu yeşil-kahve
    [SerializeField] private Color borderColor = new Color(0.3f, 0.6f, 0.2f, 1f); // Yeşil border
    [SerializeField] private Color sliderFillColor = new Color(0.4f, 0.8f, 0.3f, 1f); // Parlak yeşil
    [SerializeField] private Color sliderGlowColor = new Color(0.6f, 1f, 0.4f, 0.8f); // Açık yeşil glow
    [SerializeField] private Color textColor = new Color(0.9f, 1f, 0.8f, 1f); // Açık sarı-yeşil
    ...
    {
        // Root Canvas
        uiRoot = new GameObject("GatheringChannellingUI");
        ...
        bgImage.color = new Color(0.15f, 0.2f, 0.1f, 0.8f);
